            ...
            <form action="./SignUpComponent.jsx" onSubmit={onSubmitJoin} name="form_sign_up" id="formSignUp" method="post">
              <ul>
                ...
                <li className={`addr-hide${state.isAddrHide ? ' on' : ''}`}>
                  ...
                  <div className="right">
                    <div className="right-wrap">
                      <em className='addr-map-area'>신속배송</em>
                    ...
                    <div className="right-wrap service">
                      <ul>
                        ...
                        <li>
                          ...
                          <button type="button" onClick={onClickRequiredModalOpenFn}><span className='viewTerms'>약관보기</span><img src="./img/sign_up/arrow_right.png" alt="" /></button>
                        </li>
                        <li>
