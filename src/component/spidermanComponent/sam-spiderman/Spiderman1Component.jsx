...
export default function Spiderman1Component({샘스파}) {
  ...
  const onVillain1HoverEnter = () => {
    setIsVillain1Hovered(true);
  };

  const onVillain1HoverLeave = () => {
    setIsVillain1Hovered(false);
  };
  const onVillain2HoverEnter = () => {
    setIsVillain2Hovered(true);
  };

  const onVillain2HoverLeave = () => {
    setIsVillain2Hovered(false);
  };
  const onVillain3HoverEnter = () => {
    setIsVillain3Hovered(true);
  };

  const onVillain3HoverLeave = () => {
        ...
        <div className="sec6-container">
            ...
            <div className="character">
              ...
              <div className="character-content">
                <ul className='character-ul'>
                  ...
                  <li className={isVillain1Hovered  ? 'green-goblin' : 'norman-osborn'} onMouseEnter={onVillain1HoverEnter} onMouseLeave={onVillain1HoverLeave}>
                    <a href="#!">
                      <div className="img-box">
                        <img src={isVillain1Hovered  ? `${samSrc}spiderman1_green-goblin_character.jpg` : `${samSrc}spiderman1_norman-osborn_character.jpg`} alt="" />
                      </div>
                      <div className="caption-box">
                        <ul className='caption-ul'>
              ...
              <div className="character-content">
                <ul className='character-ul'>
                  <li className={isSpidermanHovered  ? 'spiderman' : 'peter-parker'} onMouseEnter={onSpidermanHoverEnter} onMouseLeave={onSpidermanHoverLeave}>
                    <a href="#!">
                      <div className="img-box">
                        <img src={isSpidermanHovered  ? `${samSrc}spiderman2_spiderman_character.jpg` : `${samSrc}spiderman2_peter-parker_character.jpg`} alt="" />
                      </div>
                      <div className="caption-box">
                        <ul className='caption-ul'>
                          <li><span className='character-name'>{isSpidermanHovered  ? 'spider-man' : 'peter-parker'}</span></li>
                  ...
                  <li>
                    <a href="#!">
                      <div className="img-box">
                        <img src={`${samSrc}spiderman2_mary-jane-watson_character.jpg`} alt="" />
                      </div>
                      <div className="caption-box">
                        <ul className='caption-ul'>
                          <li><span className='character-name'>mary-jane</span></li>
                  ...
                  <li className={isVillain1Hovered  ? 'Doctor-Octopus' : 'Otto-Octavius'} onMouseEnter={onVillain1HoverEnter} onMouseLeave={onVillain1HoverLeave}>
                    <a href="#!">
                      <div className="img-box">
                        <img src={isVillain1Hovered  ? `${samSrc}spiderman2_dr.otto_character.jpg` : `${samSrc}spiderman2_octavius_character.jpg`} alt="" />
                      </div>
                      <div className="caption-box">
                        <ul className='caption-ul'>
                          <li><span className='character-name'>{isVillain1Hovered  ? 'Doctor-Octopus' : 'Otto-Octavius'}</span></li>
                  ...
                  <li>
                    <a href="#!">
                      <div className="img-box">
                        <img src={`${samSrc}spiderman2_harry-osborn_character.jpg`} alt="" />
                      </div>
                      <div className="caption-box">
                        <ul className='caption-ul'>
                          <li><span className='character-name'>harry-osborn</span></li>
          ...
          <div className="movie-intro">
            ...
            <div className="character">
              ...
              <div className="character-content">
                <div className="character-row1">
                  <ul className='character-ul'>
                    <li className={isSpiderMan3 ? 'spiderman3' : ''} onMouseEnter={onSpidermanHoverEnter} onMouseLeave={onSpidermanHoverLeave}>
                      <a href="#!">
                        <div className="img-box">
                          <img src={isSpidermanHovered  ? `${samSrc}spiderman3_spiderman_character.jpg` : `${samSrc}spiderman3_peter-parker_character.jpg`} alt="" />
                        </div>
                        <div className="caption-box">
                          <ul className='caption-ul'>
                            <li><span className={isSpiderMan3 ? 'spiderman3-character-name' : 'character-name'}>{isSpidermanHovered  ? 'spider-man' : 'peter-parker'}</span></li>
                            <li><span className={isSpiderMan3 ? 'spiderman3-acter' : 'acter'}>Tobey Maguire</span></li>
                          </ul>
                        </div>
                      </a>
                    </li>
                    <li className={isSpiderMan3 ? 'spiderman3' : ''}>
                      <a href="#!">
                        <div className="img-box">
                          <img src={`${samSrc}spiderman2_mary-jane-watson_character.jpg`} alt="" />
                        </div>
                        <div className="caption-box">
                          <ul className='caption-ul'>
                            <li><span className={isSpiderMan3 ? 'spiderman3-character-name' : 'character-name'}>mary-jane</span></li>
                            <li><span className={isSpiderMan3 ? 'spiderman3-acter' : 'acter'}>kirsten dunst</span></li>
                          </ul>
                        </div>
                      </a>
                    </li>
                    <li className={isSpiderMan3 ? 'spiderman3' : ''} onMouseEnter={onVillain1HoverEnter} onMouseLeave={onVillain1HoverLeave}>
                      <a href="#!">
                        <div className="img-box">
                          <img src={isVillain1Hovered  ? `${samSrc}spiderman3_sandman_character.jpg` : `${samSrc}spiderman3_flint-marko_character.jpg`} alt="" />
                        </div>
                        <div className="caption-box">
                          <ul className='caption-ul'>
                            <li><span className={isSpiderMan3 ? 'spiderman3-character-name' : 'character-name'}>{isVillain1Hovered  ? 'sandman' : 'flint-marko'}</span></li>
                            <li><span className={isSpiderMan3 ? 'spiderman3-acter' : 'acter'}>Thomas Haden Church</span></li>
                          </ul>
                        </div>
                      </a>
                    </li>
                    <li className={isSpiderMan3 ? 'spiderman3' : ''} onMouseEnter={onVillain2HoverEnter} onMouseLeave={onVillain2HoverLeave}>
                      <a href="#!">
                        <div className="img-box">
                          <img src={isVillain2Hovered  ? `${samSrc}spiderman3_venom_character.jpg` : `${samSrc}spiderman3_eddie-brock_character.jpg`} alt="" />
                        </div>
                        <div className="caption-box">
                          <ul className='caption-ul'>
                            <li><span className={isSpiderMan3 ? 'spiderman3-character-name' : 'character-name'}>{isVillain2Hovered  ? 'venom' : 'eddie-brock'}</span></li>
                            <li><span className={isSpiderMan3 ? 'spiderman3-acter' : 'acter'}>Topher Grace</span></li>
                          </ul>
                        </div>
                      </a>
                    </li>
                    <li className={isSpiderMan3 ? 'spiderman3' : ''} onMouseEnter={onVillain3HoverEnter} onMouseLeave={onVillain3HoverLeave}>
                      <a href="#!">
                      <div className="img-box">
                          <img src={isVillain3Hovered  ? `${samSrc}spiderman3_green-goblin-jr_character.jpg` : `${samSrc}spiderman3_harry-osborn_character.jpg`} alt="" />
                        </div>
                        <div className="caption-box">
                          <ul className='caption-ul'>
                          <li><span className={isSpiderMan3 ? 'spiderman3-character-name' : 'character-name'}>{isVillain3Hovered  ? 'green-goblin' : 'harry-osborn'}</span></li>
                            <li><span className={isSpiderMan3 ? 'spiderman3-acter' : 'acter'}>James Franco</span></li>
                          </ul>
                        </div>
                      </a>
                    </li>
